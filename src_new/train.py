...
tf.app.flags.DEFINE_integer('max_steps', 25000,
                            """Maximum number of batches to run.""") # default:1000000
...
tf.app.flags.DEFINE_integer('summary_step', 50,
                            """Number of steps to save summary.""") # before mytest:100 # default:50
tf.app.flags.DEFINE_integer('checkpoint_step', 1000,
                            """Number of steps to save summary.""") # before mytest:1000
tf.app.flags.DEFINE_string('gpu', '0', """gpu id.""")
tf.app.flags.DEFINE_string('restore_model_path', None, """Restore model path e.g. log/model.ckpt [default: None]""")
...
def train():
  ...
  with tf.Graph().as_default():
    ...
    if FLAGS.restore_model_path is None:
      ...
      print("FLAG.restore_model_path:",FLAGS.restore_model_path)
