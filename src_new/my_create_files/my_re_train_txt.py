    ...
    with open(write_filename, 'w') as write_file_obj:
        ...
        for line in file_txt_obj.readlines():
            ...
            if remove_num == 0:
                ...
                lineStr_Rl = filename_write + "removeYl1" + "\n"
                lineStr_Rr = filename_write + "removeYr1" + "\n"
                write_file_obj.write(lineStr_Rl)
                write_file_obj.write(lineStr_Rr)
            elif remove_num == 1.25:
                lineStr_Rl = filename_write + "removeYl1_25" + "\n"
                lineStr_Rr = filename_write + "removeYr1_25" + "\n"
                write_file_obj.write(lineStr_Rl)
                write_file_obj.write(lineStr_Rr)
            elif remove_num == 1.5:
                lineStr_Rl = filename_write + "removeYl1_5" + "\n"
                lineStr_Rr = filename_write + "removeYr1_5" + "\n"
                write_file_obj.write(lineStr_Rl)
                write_file_obj.write(lineStr_Rr)
            elif remove_num == 1.75:
                lineStr_Rl = filename_write + "removeYl1_75" + "\n"
                lineStr_Rr = filename_write + "removeYr1_75" + "\n"
                write_file_obj.write(lineStr_Rl)
                write_file_obj.write(lineStr_Rr)
            elif remove_num == 2.0:
                lineStr_Rl = filename_write + "removeYl2" + "\n"
                lineStr_Rr = filename_write + "removeYr2" + "\n"
                write_file_obj.write(lineStr_Rl)
                write_file_obj.write(lineStr_Rr)
            else:
                write_file_obj.write(filename_write + '\n')
